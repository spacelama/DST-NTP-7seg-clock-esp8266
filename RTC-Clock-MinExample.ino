...
String http_uptime_stub() {
    return "last sync: " + String(tnow-tlast_ntp_sync) + " seconds\n";
}
                ...
                for (int i=0;i<4;i++) {
                    ...
                    switch (c) {
                        ...
                        /* ****generate a letter via***:
                            while read hex ; do
                            dec=$(opfloat "$hex") ; echo "obase=16
                            $dec" | bc
                            done
                        */

                      case 'A': enc=0x77; break;
                      case 'a': enc=0x5F; break;
                      ...
                      case 'i': enc=0x04; break;
                      case 'k': enc=0x76; break;   // H
                      case 'l': enc=0x38; break;
                      case 'O': enc=0x3f; break;
                      case 'o': enc=0x5c; break;
                      case 'r': enc=0x50; break;
                      case 'u': enc=0x1C; break;   // u
                      case 'v': enc=0x3E; break;   // V
